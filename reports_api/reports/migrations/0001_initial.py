# Generated by Django 2.1.7 on 2019-04-04 19:29
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='category',
            field=models.ForeignKey(db_column='CategoryID', on_delete=django.db.models.deletion.CASCADE, related_name='events', to='reports.EventCategory'),
        ),
        migrations.AddField(
            model_name='summitevent',
            name='location',
            field=models.ForeignKey(db_column='LocationID', on_delete=django.db.models.deletion.CASCADE, related_name='events', to='reports.AbstractLocation'),
        ),
        migrations.AddField(
            model_name='summitevent',
            name='summit',
            field=models.ForeignKey(db_column='SummitID', on_delete=django.db.models.deletion.CASCADE, related_name='events', to='reports.Summit'),
        ),
        migrations.AddField(
            model_name='summitevent',
            name='tags',
        ...
        migrations.AddField(
            model_name='summitevent',
            name='type',
            field=models.ForeignKey(db_column='TypeID', on_delete=django.db.models.deletion.CASCADE, related_name='events', to='reports.EventType'),
        ),
        migrations.AddField(
