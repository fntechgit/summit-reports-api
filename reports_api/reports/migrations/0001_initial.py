# Generated by Django 2.1.7 on 2023-05-02 20:56
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='BadgeFeatureQuestions',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('badge_feature_id', models.ForeignKey(db_column='SummitBadgeFeatureTypeID', on_delete=django.db.models.deletion.CASCADE, to='reports.BadgeFeature')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('badge_feature_id', models.ForeignKey(db_column='SummitBadgeFeatureTypeID', on_delete=django.db.models.deletion.CASCADE, to='reports.BadgeFeature')),
                ('badge_id', models.ForeignKey(db_column='SummitAttendeeBadgeID', on_delete=django.db.models.deletion.CASCADE, to='reports.Badge')),
            ],
            options={
        ...
        migrations.CreateModel(
            name='BadgeTypeFeatures',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('badge_feature_id', models.ForeignKey(db_column='SummitBadgeFeatureTypeID', on_delete=django.db.models.deletion.CASCADE, to='reports.BadgeFeature')),
                ('badge_type_id', models.ForeignKey(db_column='SummitBadgeTypeID', on_delete=django.db.models.deletion.CASCADE, to='reports.BadgeType')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(db_column='Created', default=None, null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.TextField(choices=[('Reserved', 'Reserved'), ('Cancelled', 'Cancelled'), ('RefundRequested', 'RefundRequested'), ('Refunded', 'Refunded'), ('Confirmed', 'Confirmed'), ('Paid', 'Paid')], db_column='Status')),
                ('owner', models.ForeignKey(db_column='OwnerID', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='tickets', to='reports.SummitAttendee')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.TextField(db_column='Name')),
                ('description', models.TextField(db_column='Description')),
                ('badge_type', models.ForeignKey(db_column='BadgeTypeID', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='ticket_types', to='reports.BadgeType')),
                ('summit', models.ForeignKey(db_column='SummitID', on_delete=django.db.models.deletion.CASCADE, related_name='ticket_types', to='reports.Summit')),
            ],
            options={
        ...
        migrations.CreateModel(
            name='TicketTypeQuestions',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('ticket_type_id', models.ForeignKey(db_column='SummitTicketTypeID', on_delete=django.db.models.deletion.CASCADE, to='reports.TicketType')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('attendee', models.ForeignKey(db_column='SummitAttendeeID', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='metrics', to='reports.SummitAttendee')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('moderator', models.ForeignKey(db_column='ModeratorID', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='moderated_presentations', to='reports.Speaker')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='promocode',
            field=models.ForeignKey(db_column='PromoCodeID', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='tickets', to='reports.PromoCode'),
        ),
        migrations.AddField(
            model_name='summitticket',
            name='type',
            field=models.ForeignKey(db_column='TicketTypeID', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='tickets', to='reports.TicketType'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            name='features',
            field=models.ManyToManyField(related_name='badge_types', through='reports.BadgeTypeFeatures', to='reports.BadgeFeature'),
        ),
        migrations.AddField(
            model_name='badgetype',
            name='summit',
            field=models.ForeignKey(db_column='SummitID', on_delete=django.db.models.deletion.CASCADE, related_name='badge_types', to='reports.Summit'),
        ),
        migrations.AddField(
            model_name='badgefeature',
            name='summit',
            field=models.ForeignKey(db_column='SummitID', on_delete=django.db.models.deletion.CASCADE, related_name='badge_features', to='reports.Summit'),
        ),
        migrations.AddField(
            model_name='badge',
            name='features',
            field=models.ManyToManyField(related_name='badges', through='reports.BadgeFeatures', to='reports.BadgeFeature'),
        ),
        migrations.AddField(
            model_name='badge',
            name='ticket',
            field=models.OneToOneField(db_column='TicketID', on_delete=django.db.models.deletion.CASCADE, related_name='badge', to='reports.SummitTicket'),
        ),
        migrations.AddField(
            model_name='badge',
            name='type',
            field=models.ForeignKey(db_column='BadgeTypeID', on_delete=django.db.models.deletion.CASCADE, related_name='badges', to='reports.BadgeType'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='tickettypequestions',
            name='question_id',
            field=models.ForeignKey(db_column='SummitOrderExtraQuestionTypeID', on_delete=django.db.models.deletion.CASCADE, to='reports.SummitOrderExtraQuestionType'),
        ),
        migrations.AddField(
            model_name='tickettype',
            name='questions',
            field=models.ManyToManyField(related_name='ticket_types', through='reports.TicketTypeQuestions', to='reports.SummitOrderExtraQuestionType'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='eventmetric',
            name='room',
            field=models.ForeignKey(db_column='SummitVenueRoomID', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='metrics', to='reports.VenueRoom'),
        ),
        migrations.AddField(
            model_name='badgefeaturequestions',
            name='question_id',
            field=models.ForeignKey(db_column='SummitOrderExtraQuestionTypeID', on_delete=django.db.models.deletion.CASCADE, to='reports.SummitOrderExtraQuestionType'),
        ),
        migrations.AddField(
            model_name='badgefeature',
            name='questions',
            field=models.ManyToManyField(related_name='badge_features', through='reports.BadgeFeatureQuestions', to='reports.SummitOrderExtraQuestionType'),
        ),
    ]
